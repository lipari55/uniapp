	...
	<div class="dropdown-item">
		...
		<view class="dropdown-item__selected" 
			...
			<block v-else>
				...
				>
					<uni-icons size="15" type="arrowdown"></uni-icons>
				</view>
			</block>
		</view>
		<view class="dropdown-item__content" style="top: 145px;" v-if="showList">
			<!-- dropdown -->
				...
				<block v-else>
					<view class="list__option"
						  ...
						  :key="index"
						   @click="choose(item)">
						<view >{{item.text}}</view>
						<uni-icons v-if="item.value === value" type="checkmarkempty" size="20">	</uni-icons>
					</view>
				</block>
			</view>	
			<!-- dropdown-mask -->
