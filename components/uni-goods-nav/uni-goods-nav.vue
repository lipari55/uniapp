<template>
	<view class="uni-goods-nav">
		...
		<view class="uni-tab__cart-box flex">
			...
			<view class="flex uni-tab__cart-sub-left">
				<view v-for="(item,index) in options" :key="index" class="flex uni-tab__cart-button-left uni-tab__shop-cart" @click="onClickPrice(index,item)">
					
					
					<view class="tot-price">
						
						<!-- <image class="image" :src="item.icon" mode="widthFix" /> -->
					</view>
					<text class="tot-price-text"></text>	
				</view>
			</view>			
